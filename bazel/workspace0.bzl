...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.84.0-pre2.tar.gz",
        ],
        sha256 = "46a012c7d362cc0dd318e8619d6fd2c0e0c3a4c3ac7cb62ecf1fd6742398308e",
        strip_prefix = "grpc-1.84.0-pre2",
    )
